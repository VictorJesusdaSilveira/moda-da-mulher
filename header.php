  ...
  <header class="bg-cor-primaria">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-7 my-4 d-flex align-items-center">
        ...
        <div class="col-md-3 d-flex align-items-center justify-content-end">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link text-secondary" href="#"><i class="bi bi-cart-fill position-relative"><span class=" badge position-absolute top-0 start-100 translate-middle bg-danger rounded-circle">3<span class="visually-hidden">New alerts</span></span></i> carrinho</a>
            </li>
          </ul>
